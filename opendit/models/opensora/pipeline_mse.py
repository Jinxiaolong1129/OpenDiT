...
from .rflow_mse import RFLOW
from .stdit3_mse import STDiT3_XL_2
from .text_encoder import T5Encoder, text_preprocessing
from .vae import OpenSoraVAE_V1_2


class OpenSoraPABConfig_mse(PABConfig):
    def __init__(
        self,
        steps: int = 50,
...
class OpenSoraConfig_mse:
    def __init__(
        ...
        pab_config: PABConfig = OpenSoraPABConfig_mse(),
    ):
...
class OpenSoraPipeline_mse(VideoSysPipeline):
    r"""
    ...
    def __init__(
        self,
        config: OpenSoraConfig_mse = OpenSoraConfig_mse(),
    ...
    def generate(
        ...
        for loop_i in range(loop):
            ...
            samples, spatial_mlp_mse, temporal_mlp_mse = self.scheduler.sample(  # BUG
                self.transformer,
                self.text_encoder,
                z=z,
        ...
        save_path = f"./outputs/opensora/opensora_{prompt[0:10]}.mp4"
        ...
        return VideoSysPipelineOutput(video=video), spatial_mlp_mse, temporal_mlp_mse
